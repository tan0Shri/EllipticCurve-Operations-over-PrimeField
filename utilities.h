...
void ADD(uint32_t*, uint32_t*, uint32_t*, uint32_t); // Performs addition on uint32_t arrays, packed addition in base 29
void FieldAddition(uint32_t*, uint32_t*, uint8_t*);
